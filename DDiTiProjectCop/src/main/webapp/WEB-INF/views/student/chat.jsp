			...
			<div class="col-lg-9 col-12">
				<div class="row">
					<div class="col-lg-6 col-md-8 col-12">
						  ...
						  <div class="box-body" style="max-height: 500px; overflow-y: hidden;">
...
<div class="col-xxxl-4 col-lg-5 col-12">
	...
	<div class="box">
		<div class="box-header with-border">
		  <h4 class="box-title">상담 내용</h4>
		</div>
		<!-- /.box-header -->
		<div class="box-body">
			<div class="form-group">
				<label class="form-label">상담 내용 :</label>
				<textarea rows="5" class="form-control" placeholder="상담 내용 작성"></textarea>
			</div>
		</div>
		<!-- /.box-body -->
	  </div>
