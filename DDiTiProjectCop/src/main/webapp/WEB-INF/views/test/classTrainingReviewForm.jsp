	...
	<div class="table-responsive">
		<div class="col-md-2">
			<div class="box box-inverse box-info ">
				...
				<div class="box-body dataTables_wrapper container-fluid dt-bootstrap4 no-footer row col-md-3">
					...
					<div class="form-group col-lg-4 col-10">
						<span class="text-danger">*</span>
							<label class="form-label">현장실습 후기</label>
								<textarea rows="10" cols="20" class="form-control" placeholder="About Project"></textarea>
					</div>
			</div>		
	</div>
